		...
		<div class="card-header">
			<div class="d-flex align-items-center">
				<h4 class="card-title">Service FAQ</h4>
					<a href="{{ route('servicefaq.create') }}" class="btn btn-primary btn-round ml-auto" >
					...
					<tr>
						...
						<td>
							<div class="form-button-action">
                                <a href="{{route('servicefaq.edit', $value->id)}}"  class="btn-sm btn-info"><i class="far fa-edit"></i></a>&nbsp;
							...
							<form action="{{ route('servicefaq.destroy', [$value->id]) }}" method="post"enctype="multipart/form-data" >
									 @csrf
