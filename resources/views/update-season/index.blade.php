		...
		<div class="card-header">
			<div class="d-flex align-items-center">
				<h4 class="card-title">Services</h4>
					<a href="{{ route('update-season.create') }}" class="btn btn-primary btn-round ml-auto" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('update-season.destroy', [$data->id]) }}" method="post"enctype="multipart/form-data" >
                                    @csrf
