...
<div class="page-inner">
	...
	<div class="card mb-4">
		<h6 class="card-header">Create New Policy Image</h6>
		<!-- <form> -->
			<form action="{{route('policybannerimg.store')}}" method = "post"  enctype="multipart/form-data" >
				{{csrf_field()}}
			<div class="card-body">
                <label class="mt-3 mb-3"><b>Banner Image </b></label>
				<div class="form-group">
					<input type="file"  name="policy_img" required id="image">
