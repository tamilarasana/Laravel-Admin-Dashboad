		...
		<!-- <form> -->
			...
			<div class="card-body">
				...
				<div class="form-group form-floating-label">
					<input id="inputFloatingLabel"  name ="season_name" type="text"  value ="{{$season->season_name}}" class="form-control input-border-bottom" required>
					<label for="inputFloatingLabel" class="placeholder">Season Name</label>
				</div>

                <label class="mt-3 mb-3"><b>Description</b></label>
				<div class="form-group form-floating-label">
					<textarea id="inputFloatingLabel"  name ="description" type="text"  class="form-control input-border-bottom" placeholder ="Enter Your Description" required>{{$season->description}}</textarea>
				</div>
                <label class="mt-3 mb-3"><b>Blog Position</b></label>
				<div class="form-group form-floating-label">
					<input id="inputFloatingLabel"  name ="b_position" type="text" value ="{{$season->b_position}}" class="form-control input-border-bottom" required>
					<label for="inputFloatingLabel" class="placeholder">Blog Position</label>
				</div>
                <label class="mt-3 mb-3"><b>Index Position</b></label>
				<div class="form-group form-floating-label">
					<input id="inputFloatingLabel"  name ="i_position" type="text"  value ="{{$season->i_position}}"class="form-control input-border-bottom" required>
